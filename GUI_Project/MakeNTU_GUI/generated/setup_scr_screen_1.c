...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_1_btn_1, 242, 1);
    lv_obj_set_size(ui->screen_1_btn_1, 237, 318);
    ...
    lv_obj_set_pos(ui->screen_1_btn_2, 4, -2);
    lv_obj_set_size(ui->screen_1_btn_2, 217, 318);
