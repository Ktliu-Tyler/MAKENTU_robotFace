...
int Sleep_digital_clock_1_min_value = 38;
int Sleep_digital_clock_1_hour_value = 1;
int Sleep_digital_clock_1_sec_value = 15;
char Sleep_digital_clock_1_meridiem[] = "AM";
void setup_scr_Sleep(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->Sleep_eyeR, 80, 10);
    ...
    lv_obj_set_size(ui->Sleep_eyeL, 80, 10);
    ...
    //Write codes Sleep_digital_clock_1
    static bool Sleep_digital_clock_1_timer_enabled = false;
    ui->Sleep_digital_clock_1 = lv_dclock_create(ui->Sleep, "1:38:15 AM");
    if (!Sleep_digital_clock_1_timer_enabled) {
        lv_timer_create(Sleep_digital_clock_1_timer, 1000, NULL);
        Sleep_digital_clock_1_timer_enabled = true;
    }
    lv_obj_set_pos(ui->Sleep_digital_clock_1, 12, 26);
    lv_obj_set_size(ui->Sleep_digital_clock_1, 432, 110);

    //Write style for Sleep_digital_clock_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_radius(ui->Sleep_digital_clock_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->Sleep_digital_clock_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Sleep_digital_clock_1, &lv_font_AmaticSC_Regular_70, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->Sleep_digital_clock_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->Sleep_digital_clock_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->Sleep_digital_clock_1, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->Sleep_digital_clock_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->Sleep_digital_clock_1, 7, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->Sleep_digital_clock_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->Sleep_digital_clock_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->Sleep_digital_clock_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->Sleep_digital_clock_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_long_mode(ui->Sleep_btn_1_label, LV_LABEL_LONG_CLIP);
    ...
    lv_obj_set_pos(ui->Sleep_btn_1, 200, 203);
    lv_obj_set_size(ui->Sleep_btn_1, 37, 23);
    ...
    lv_obj_set_style_bg_color(ui->Sleep_btn_1, lv_color_hex(0xcae2f8), LV_PART_MAIN|LV_STATE_DEFAULT);
