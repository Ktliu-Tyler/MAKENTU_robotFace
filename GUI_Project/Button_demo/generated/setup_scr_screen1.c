...
void setup_scr_screen1(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen1, 480, 320);
    ...
    lv_label_set_text(ui->screen1_btn_1_label, "Button");
    ...
    lv_obj_set_width(ui->screen1_btn_1_label, LV_PCT(100));
    lv_obj_set_pos(ui->screen1_btn_1, 190, 135);
    lv_obj_set_size(ui->screen1_btn_1, 100, 50);
    ...
    lv_obj_set_style_bg_color(ui->screen1_btn_1, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen1_btn_1, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen1_btn_1, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen1_btn_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen1_btn_1, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);

    //The custom code of screen1.
